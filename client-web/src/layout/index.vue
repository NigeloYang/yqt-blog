<template>
	<main class="yqt-layout-all-group" id="yqt-layout-all-group" ref="layoutGroup">
		<!--菜单栏-->
		<section class="yqt-theme-header"
						 v-if="router.currentRoute.value.path === '/index'"
						 :style="{top:showHeader?0:'-100%'}"
		>
			<div class="header-logo">
				<span class="logo-text" @click="goIndex">{{ setting.websiteInfo.name || 'Richard Yang' }}</span>
			</div>
...
import YqtMenuList from '../components/common/YqtMenuList.vue'
import YqtGoTop from '../components/common/YqtGoTop.vue'
